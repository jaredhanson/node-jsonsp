 ...
 *
 * Options:
 *   - `allowComments`  allow JavaScript comments in JSON input, defaults to _false_
 *
 * Events:
 *
 *   Event: 'object'
...
function Parser(options, objectListener) {
  ...
  options = options || {};
  options.allowMultipleValues = (options.allowMultipleValues === undefined) ? true : options.allowMultipleValues;
